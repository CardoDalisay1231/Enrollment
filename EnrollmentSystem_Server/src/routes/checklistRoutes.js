 ...
 */
router.get('/', authorize('registrar', 'department_head'), getAllChecklists);
 ...
 *         description: Unauthorized
 */
router.get('/:id', authorize('registrar', 'department_head'), getChecklistById);
 ...
 *         description: Unauthorized
 */
router.get('/program/:program_id', authorize('registrar', 'department_head'), getChecklistsByProgramId);
 ...
 *         description: Unauthorized
 */
router.get('/course/:course_code', authorize('registrar', 'department_head'), getChecklistsByCourseCode);
 ...
 *         description: Unauthorized
 */
router.post('/', authorize('registrar'), createChecklist);
 ...
 *         description: Unauthorized
 */
router.put('/:id', authorize('registrar'), updateChecklist);
 ...
 *         description: Unauthorized
 */
router.delete('/:id', authorize('registrar'), deleteChecklist);
